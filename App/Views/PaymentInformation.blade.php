...
<div class="container">
    ...
    <div class="row setup-content" id="step-1">
        ...
        <div class="row setup-content" id="step-2">
            <div class="col-xs-12">
                <div class="col-md-12">
                        <form action="/register/store/step3/{{user()['id']}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input maxlength="200" type="text" required="required" class="form-control" placeholder="Enter IBAN" name="IBAN" id="IBAN"  />
                            ...
                            <div class="form-group">
                                <input maxlength="200" type="hidden" required="required" class="form-control" value="{{user()['id']}}" name="user_id" id="user_id"  />
                            </div>
